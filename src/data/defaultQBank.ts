...
export const DEFAULT_PYQ_INDEX: PYQItem[] = [
  ...
  },
  {
    ...
    roleTag: 'DIAGNOSIS',
    explanation: 'Post-MI Ventricular Septal Rupture presents with cardiogenic shock and a harsh holosystolic murmur with thrill at the left sternal border. Acute mitral MR from papillary muscle rupture produces an apical murmur blowing to axilla usually without thrill.'
  },
  {
    qid: 'NEETPG-2020-045',
    exam: 'NEET-PG',
    ...
    options: {
      A: 'Intravenous Amiodarone 150 mg slow infusion',
      B: 'Synchronized DC cardioversion 100 J',
  ...
  },
  {
    ...
    options: {
      A: 'Serum cold agglutinins assay',
      B: 'HRCT Chest with contrast',
      C: 'Bronchoalveolar lavage PCR for Legionella',
      D: 'Sputum culture and urinary pneumococcal antigen test'
    },
    correctAnswer: 'D',
  ...
  },
  {
    ...
    options: {
      ...
      B: 'Serum Potassium level (maintain >3.3 - 5.0 mEq/L)',
  ...
  },
  {
    ...
    options: {
      A: 'Immediate portable Chest X-ray',
      B: 'Endotracheal intubation with positive pressure ventilation',
      C: 'Urgent CT Scan of Chest',
      D: 'Needle decompression in 2nd intercostal space midclavicular line (or 5th ICS anterior axillary line)'
    },
    correctAnswer: 'D',
  ...
  },
  {
    ...
    options: {
      A: 'Intravenous Diazepam 10 mg',
      B: 'Magnesium Sulfate IV (Pritchard or Zuspan regimen)',
  ...
  },
  {
    ...
    options: {
      A: 'Ototoxicity and Vestibular dysfunction',
      B: 'Nephrotoxicity and Neuromuscular blockade',
  ...
  },
  {
    ...
    options: {
      A: 'Standard ORS at 100 mL/kg rapid bolus',
      B: 'Hypertonic 3% Saline IV infusion',
      C: 'ReSoMal (Rehydration Solution for Malnutrition) or half-strength Darrow solution',
